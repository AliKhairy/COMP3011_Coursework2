...
class InvertedIndex:
    ...
    def save_to_file(self, filepath: str = "data/index.json"):
        ...
        # 1. Extract the directory path (e.g., 'data') from the full filepath
        directory = os.path.dirname(filepath)
        
        # 2. If there is a directory specified, create it! (exist_ok=True prevents crashes if it's already there)
        if directory:
